...
import { ExamsTab } from "@/pages/painel/ExamsTab";

/** Provas — escolhe a disciplina primeiro, depois gerencia as provas dela. */
    ...
    <PainelShell
      ...
      description={
        selected
          ...
          : "Escolha uma disciplina para criar ou gerenciar provas."
      }
    >
      {selected ? (
        <div>
          ...
          <ExamsTab disciplineId={selected.id} />
        </div>
